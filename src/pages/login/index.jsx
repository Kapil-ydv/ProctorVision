...
const LoginPage = () => {
  ...
  useEffect(() => {
    ...
    const authData = localStorage.getItem('proctorVisionAuth');
    if (authData) {
      try {
        ...
        localStorage.removeItem('proctorVisionAuth');
      }
    }
  }, [navigate]);
  ...
  return (
    <>
      <Helmet>
        <title>Login - ProctorVision | Secure Interview Proctoring</title>
        <meta name="description" content="Sign in to ProctorVision to access AI-powered interview proctoring and monitoring tools for secure remote interviews." />
